  ...
  return (
    <main className="clerk-subscriptions">
      <section className="w-full max-w-4xl mx-auto text-center mb-10">
        ...
        <div className="mt-6 inline-flex items-center justify-center gap-3 px-4 py-2 rounded-full bg-[var(--bg-secondary)] border border-[var(--border-subtle)] shadow-soft-sm">
